...
//                   <tr style={{ backgroundColor: '#f9f9f9ff' }}>
//                     <th colSpan={4} style={{ border: '1px solid #ccc', padding: '8px', textAlign: 'center' }}>
//                       <h2>Tariff & Charges Calculation Details</h2>
//                     </th>
//                   </tr>
...
//                   <tr style={{ backgroundColor: '#f9f9f9ff' }}>
//                     <th colSpan={4} style={{ border: '1px solid #ccc', padding: '8px', textAlign: 'center' }}>
//                       <h3>Security Deposit Details</h3>
//                     </th>
//                   </tr>
...
//                     <TableTrBloack Lable={'Total Pay Amount'} Value={formatCurrency(htConsumers.tariff_charges.total_pay_amount)} />
//                   </tr>
                  
//                   {/* Summary Row */}
//                   <tr style={{ backgroundColor: '#e5e7eb', fontWeight: 'bold' }}>
//                     <TableTrBloack Lable={'Total SAC + Registration Fee'} Value={formatCurrency((htConsumers.tariff_charges.total_sac_amount || 0) + (htConsumers.tariff_charges.registration_fee_charges || 0))} />
