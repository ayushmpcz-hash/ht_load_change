...
//                     </div>
//                     <br></br>
//                     <strong>Note:</strong> Please merge the document pdfs, if mulltiple documents to be upload.
...
//   //     const axiosMethod = isUpdatePage ? axios.patch : axios.post;

//   //     const response = await axiosMethod(apiUrl, formData, {
//   //       headers: { "Content-Type": "multipart/form-data" },
//   //     });
...
//   //     if (!isUpdatePage && result.application_no) {
//   //       // after first submit → move to update/preview page
//   //       navigate(`/ht-load-change/update/${result.application_no}`, {
...
//     // ✅ First Submit → Go to Update Preview Page
//     if (!isUpdatePage && result.application_no) {
//       navigate(`/ht-load-change/update/${result.application_no}`, {
//         state: { data: result.data },
//       });
//     }
//     // ✅ Update Click → Go to Details Page (Payment Page)
//     else if (isUpdatePage) {
//       navigate(`/ht-load-change/Details`, {
...
//                         <button
//                           type="submit"
//                           className={`text-white px-4 py-2 mt-4 rounded ${isDisabled
