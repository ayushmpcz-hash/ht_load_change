...
//     try {
//       const erp_no = getValues(erpField);

//       // 🔴 ERP number empty check
//       if (!erp_no) {
//         setError(erpField, {
//           type: 'manual',
//           message: 'ERP Number is required',
//         });
//         return;
//       }
...
//         `${DSP_PRO_BASE}/XXPA_PROJECTS_HT_V/${erp_no}`
//       );
...
//       if (!projectData) {
//         setMeExtimateblock(false);
//         setExExtimateblock(false);
//         setError(erpField, {
//           type: 'manual',
//           message: 'No data found for this ERP No',
//         });
//         return;
//       }
...
//         setError(erpField, {
//           type: 'manual',
//           message: 'Estimate is not Approved',
//         });
//         return;
//       }
...
//       const sanctionDate =
//         SANCTION_DATE
//           ? new Date(SANCTION_DATE).toISOString().split('T')[0]
//           : '';
...
//          ======================= */
//       if (type === 'ME') {
//         // ❌ Invalid scheme for ME
//         if (!['DEPOSITE', 'SCCW'].includes(SCHEMECODE)) {
//           setMeExtimateblock(false);
//           setError(erpField, {
//             type: 'manual',
//             message: 'Invalid ME Meter ERP No',
//           });
//           return;
//         }

//         // ✅ Open ME estimate block
//         setMeExtimateblock(true);

//         setValue('ndf_approved_by_name', APPROVED_BY_NAME || '');
//         setValue('ndf_estimate_date', sanctionDate);
//         setValue('ndf_sanction_amt', SANCT_COST || 0);
//         setValue('ndf_long_name', LONG_NAME || '');
//         setValue('ndf_status', STATUS);
//         setValue('ndf_scheme_name', SCHEMECODE);
//         setValue('ndf_circle_name', ORG1 || '');
//         setValue('ndf_division_name', ORG || '');
//         setValue('ndf_total_amt', SANCT_COST || 0);
//       }

//       /* =======================
//          🟢 EXTENSION ESTIMATE CASE
//          ======================= */
//       if (type === 'EXT') {
//         setExExtimateblock(true);

//         const halfSuperTax = Number(SUPER_TAX) / 2;

//         setValue('status', STATUS);
//         setValue('scheme_name', SCHEMECODE);
//         setValue('supervision_cgst', halfSuperTax.toFixed(2));
//         setValue('supervision_sgst', halfSuperTax.toFixed(2));
//         setValue('supervision_amt', Math.ceil(SUPERVISION_COST));
//         setValue('long_name', LONG_NAME || '');
//         setValue('estimate_date', sanctionDate);

//         // 🔁 SCCW special calculation
//         if (SCHEMECODE === 'SCCW') {
//           setValue(
//             'total_estimated_amt',
//             Math.ceil(Number(SUPER_TAX) + Number(SUPERVISION_COST))
...
//       setError(erpField, {
//         type: 'manual',
//         message: 'ERP Number does not exist',
//       });
//     } finally {
//       setIsDisabled(false);
//     }
...
//     /* =================================================
//        🟢 AGREEMENT REQUIRED CASE
//        ERP validation SKIP
//        ================================================= */
//     if (is_required === 'is_agreement_required') {
//       handleFinalSubmit();
//       return;
//     }

//     /* =================================================
//        🟢 ESTIMATE REQUIRED CASE
//        ERP validation MANDATORY
//        ================================================= */
//     if (is_required === 'is_estimate_required') {

//       // 🔒 ME Meter ERP mandatory
//       if (
//         is_estimate_required.includes('is_me_meter_required') &&
//         !meExtimateblock
//       ) {
//         alert('Please fetch ME Meter ERP details first');
//         setBtnIsDisabled(false);
//         return;
//       }

//       // 🔒 Extension ERP mandatory
//       if (
//         is_estimate_required.includes('is_extension_work_required') &&
//         !exExtimateblock
//       ) {
//         alert('Please fetch Extension Work ERP details first');
//         setBtnIsDisabled(false);
//         return;
//       }
//     }
