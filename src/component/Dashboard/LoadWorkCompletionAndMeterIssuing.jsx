...
const LoadWorkCompletionAndMeterIssuing = () => {
  ...
  //         ngbToken
  //       );
  //       console.log(models,'me modelsssss')
    ...
    (async () => {
      try {
        const models = await getPublicData(
          // `https://services.mpcz.in/HT-NIC/api/htPublicApis/getAllModelsByMeterManufacturer/${me_make}`
          `https://services.mpcz.in/HT-NIC/api/htPublicApis/getAllCTModelByCTManufacturer/${me_make}`
          //  `https://services.mpcz.in/HT-NIC/api/htPublicApis/getAllPTModelByPTManufacturer/${me_make}`
          // `https://uathtngb.mpcz.in:8888/htngb_backend/api/masters/getAllCTModelByCTManufacturer/${me_make}`
        );
                        ...
                        <>
                          ...
                          >
                            {isSendOtpLoading
                              ? "Please wait..."
                              : work_completion_response === "Reverted"
                                ? "Revert For agreement Finalization"
