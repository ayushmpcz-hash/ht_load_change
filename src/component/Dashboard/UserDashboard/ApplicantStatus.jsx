    ...
    <div className="card mt-2 mb-2 bg-white rounded-lg shadow-md">
      ...
      <div className="card-body px-6 pb-6 pt-4">
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
          <h3 className="text-sm font-semibold text-gray-700 mb-4 border-b pb-2">Load Enhancement Details</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              <div>
                <p className="text-xs text-gray-500">Existing Contract Demand</p>
                <p className="text-sm font-medium">{items?.existing_contract_demand || 'N/A'} kW</p>
              </div>
              <div>
                <p className="text-xs text-gray-500">Existing Supply Voltage</p>
                <p className="text-sm font-medium">{items?.existing_supply_voltage || 'N/A'}</p>
              </div>
              <div>
                <p className="text-xs text-gray-500">Contract Demand Difference</p>
            ...
            <div className="space-y-2">
              <div>
                <p className="text-xs text-gray-500">New Contract Demand</p>
                <p className="text-sm font-medium">{items?.new_contact_demand || 'N/A'} kW</p>
              </div>
              <div>
                <p className="text-xs text-gray-500">New Supply Voltage</p>
            ...
            <div className="space-y-2">
              <div>
                <p className="text-xs text-gray-500">Connection Purpose</p>
                <p className="text-sm font-medium">{items?.connection_sub_category || items?.purpose_of_installation_details || 'N/A'}</p>
              </div>
              <div>
                <p className="text-xs text-gray-500">Connection Category</p>
        ...
        <div className="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
          <h3 className="text-sm font-semibold text-gray-700 mb-3 border-b pb-2">Additional Information</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              <div>
              ...
              <div>
                <p className="text-xs text-gray-500">PAN Card No</p>
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            <h3 className="text-sm font-semibold text-gray-700 mb-3 border-b pb-2">Meter Details</h3>
            <div className="space-y-2">
              <div>
                <p className="text-xs text-gray-500">Meter Information</p>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <p className="text-xs text-gray-500">CT Ratio</p>
                  <p className="text-sm font-medium">{items?.me_ct_ratio || items?.meter_ct_ratio || 'N/A'}</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500">PT Ratio</p>
                  <p className="text-sm font-medium">{items?.me_pt_ratio || items?.meter_pt_ratio || 'N/A'}</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <p className="text-xs text-gray-500">Meter Accuracy</p>
                  <p className="text-sm font-medium">{items?.meter_accuracy || 'N/A'}</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500">Multiplication Factor</p>
                  <p className="text-sm font-medium">{items?.mf || 'N/A'}</p>
                </div>
              </div>
              {items?.me_serial_no && (
                <div>
                  <p className="text-xs text-gray-500">ME Serial No</p>
                  <p className="text-sm font-medium">{items.me_serial_no}</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
            <h3 className="text-sm font-semibold text-gray-700 mb-3 border-b pb-2">Current Billing Information</h3>
            <div className="space-y-2">
              <div>
                <p className="text-xs text-gray-500">Current Bill ID</p>
              ...
              <div>
                <p className="text-xs text-gray-500">Net Bill Amount</p>
