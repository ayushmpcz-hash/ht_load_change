...
//                         <button
//                           type="submit"
//                           className={`px-4 py-2 rounded text-white ${isDisabled || isBtnDisabled ? "bg-gray-400 cursor-not-allowed" : "bg-green-500 hover:bg-purple-800"}`}
          ...
          <div className="card mt-2 mb-2 bg-white rounded shadow-md ">
            ...
            <div className="card-body px-4 pb-4">
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-8">
                ...
                {/* Remark textarea */}
                {/* REMARK WIDTH REDUCED */}
                {/* <div className="sm:col-span-3">
                  <InputTag LName="Remark" {...register("remark")} disabled={isDisabled} />
                </div> */}
              </div>
              ...
              <div className="mt-10 flex flex-col justify-center items-center">
                ...
                {errors?.otpSuccess && <p className="text-green-600">{errors.otpSuccess.message}</p>}
                {errors?.otpStatus && <p className="text-red-600">{errors.otpStatus.message}</p>}
              </div>
            </div>
          </div>
        )}
